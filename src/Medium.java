...
public class Medium extends JPanel implements KeyListener{
    	...
    	*/
    	...
    	public Medium() throws FileNotFoundException, IOException {
    		this.setSize(new Dimension(1720, 760));
    		testPlayer = new Character("Blue",80, 240, 60, 40, 0);
...
//	    		
	    		...
	    		if (itemList.get(a) instanceof ProjectileLauncher) {
	    			if (lastNum < convSec) {
	        	    	...
	        	    	try {
							ProjectileList.get(ProjectileList.size()-1).setImage(ImageIO.read(new File("C:\\Users\\Michael\\eclipse-workspace\\ughPath\\src/Cannonball.png")));
						} catch (IOException e) {
	    	...
	    	g.drawImage(testPlayer.getSprites()[8], testPlayer.getPosition()[0], testPlayer.getPosition()[1], testPlayer.getWidth(), testPlayer.getHeight(), this);
